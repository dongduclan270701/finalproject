        ...
        <div className="ladi-wraper" data-padding-top-id="SECTION636" data-scroll-padding-top={70} style={{ paddingTop: '70px' }}>
            ...
            <div id="SECTION745" className="ladi-section">
                ...
                <div className="ladi-container">
                    ...
                    <NavLink to=""  id="SHAPE768" className="ladi-element" data-replace-href="https://gvn360.com/">
                        <div className="ladi-shape">
                    ...
                    <NavLink to=""  id="PARAGRAPH769" className="ladi-element" data-replace-href="https://gvn360.com/">
                        <div className="ladi-paragraph">
                    ...
                    <NavLink to="" id="SHAPE772" className="ladi-element" data-replace-href="https://tuyendung.gearvn.com/">
                        <div className="ladi-shape">
                    ...
                    <NavLink to="" id="PARAGRAPH773" className="ladi-element" data-replace-href="https://tuyendung.gearvn.com/">
                        <div className="ladi-paragraph">
                            Kênh tuyển dụng<br />
                        </div>
                    </NavLink>
                    <NavLink to="" id="HEADLINE776" className="ladi-element" data-replace-href="https://gearvn.com/pages/he-thong-showroom-gearvn">
                        <h4 className="ladi-headline ladi-lazyload">
                            Hệ thống chi nhánh</h4>
                    </NavLink>
                    <NavLink to="" id="PARAGRAPH777" className="ladi-element" data-replace-href="https://gearvn.com/pages/he-thong-showroom-gearvn">
                        <div className="ladi-paragraph">
                            Khu vực miền nam</div>
                    </NavLink>
                    <NavLink to="" id="PARAGRAPH778" className="ladi-element" data-replace-href="https://gearvn.com/pages/he-thong-showroom-gearvn">
                        <div className="ladi-paragraph">
                            Khu vực miền bắc</div>
                    </NavLink>
                    <NavLink to="" id="PARAGRAPH779" className="ladi-element" data-replace-href="https://gearvn.com/pages/chinh-sach-bao-hanh">
                        <div className="ladi-paragraph">
                            Chính sách bảo hành<br />
                        </div>
                    </NavLink>
                    <NavLink to="" id="PARAGRAPH780" className="ladi-element" data-replace-href="https://gearvn.com/pages/chinh-sach-giao-hang">
                        <div className="ladi-paragraph">
                            Chính sách giao hàng<br />
                        </div>
                    </NavLink>
                    <NavLink to="" id="PARAGRAPH781" className="ladi-element" data-replace-href="https://gearvn.com/pages/chinh-sach-bao-mat">
                        <div className="ladi-paragraph">
                            Chính sách bảo mật<br />
                        </div>
                    </NavLink>
                    <NavLink to="" id="PARAGRAPH782" className="ladi-element" data-replace-href="https://gearvn.com/pages/huong-dan-tra-gop">
                        <div className="ladi-paragraph">
                            Hướng dẫn trả góp<br />
                        </div>
                    </NavLink>
                    <NavLink to="" id="PARAGRAPH783" className="ladi-element" data-replace-href="https://gearvn.com/pages/huong-dan-thanh-toan-gearvn">
                        <div className="ladi-paragraph">
                            Hướng dẫn thanh toán<br />
                        </div>
                    </NavLink>
                    <NavLink to="" id="PARAGRAPH784" className="ladi-element" data-replace-href="https://gearvn.com/pages/khuyenmaigaminggear">
                        <div className="ladi-paragraph">
                            Tổng hợp khuyến mãi<br />
                        </div>
                    </NavLink>
                    <NavLink to="" id="PARAGRAPH785" className="ladi-element" data-replace-href="https://gearvn.com/pages/he-thong-showroom-gearvn">
                        <div className="ladi-paragraph">
            ...
            <div id="SECTION886" className="ladi-section">
                <div className="ladi-section-background ladi-lazyload" />
                <div className="ladi-container">
                    <NavLink to="" id="IMAGE887" className="ladi-element" data-replace-href="https://gearvn.com/pages/chuong-trinh-tet">
                        <div className="ladi-image">
