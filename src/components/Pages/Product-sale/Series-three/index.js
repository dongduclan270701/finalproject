...
const Index = () => {
    return (
        <div id="SECTION499" className="ladi-section">
                ...
                <div className="ladi-container">
                    ...
                    <div id="HEADLINE530" className="ladi-element">
                        <h3 className="ladi-headline">
                            ...
                            <br />
                            Khách hàng bấm vào sản phẩm để xem chi tiết trên website.<br />
                        </h3>
                    </div>
                    <div id="HEADLINE537" className="ladi-element">
                        <h2 className="ladi-headline">
                            Laptop Dell XPS Series&nbsp;<br />
                        </h2>
                    </div>
                </div>
            </div>
