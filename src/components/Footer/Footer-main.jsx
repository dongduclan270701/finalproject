                        ...
                        <div className="get_email">
                            ...
                            <div id="frame_sbemail" className="pull-left col-sm-4 col-xs-12 pull-right">
                                <div className="input-group input-group-sm fix-input-group">
                                    ...
                                    <input type="text" className="form-control" name="contact[email]" id="your_email" placeholder="Enter your email" />
                                    <span className="input-group-btn">
                                        <button name="bt_submitemail" id="bt_submitemail" className="btn btn-default" type="submit">Sign up</button>
                                    </span>
                    ...
                    {/* <div className='row'> */}
                        <div id="user1" className="col-sm-4 col-xs-12">
                            <div className="moduletable">
                                ...
                                <h3>GEARVN Trading Co., Ltd</h3>
                                <div className="custom">
                                    <h3 className="title-footer-2">	Email: cskh@gearvn.com<br /></h3>
                                    <p style={{ fontSize: '14px' }}><b>FREE PBX SYSTEM:</b> (Working from 08h00 to 21h00)</p>
                                    <table style={{ width: '296px' }}>
                                        <tbody>
                                            <tr>
                                                <td style={{ width: '211px',fontSize:'14px',paddingBottom:'5px' }}>Call to buy</td>
                                                <td style={{ width: '105px',fontSize:'14px',paddingBottom:'5px' }}><strong>1800 6975</strong></td>
                                            </tr>
                                            <tr>
                                                <td style={{ width: '211px',fontSize:'14px' }}>Customer support</td>
                                    ...
                                    <br />
                                    <div><NavLink to="" style={{ fontSize: '16px', color: '#0655a6', fontWeight: 'bold' }}>Warranty Policy</NavLink></div><br />
                                    <div><NavLink to="" style={{ fontSize: '16px', color: '#0655a6', fontWeight: 'bold' }}>Payment policy</NavLink></div><br />
                                    <div><NavLink to="" style={{ fontSize: '16px', color: '#0655a6', fontWeight: 'bold' }}>Delivery policy</NavLink></div><br />
                                    <div><NavLink to="" style={{ fontSize: '16px', color: '#0655a6', fontWeight: 'bold' }}>Privacy Policy</NavLink></div>
                                </div>
                        ...
                        <div id="user2" className="col-sm-5 col-xs-12">
                            <div className="moduletable">
                                ...
                                <p style={{ fontSize: '16px', display: 'inline' }}>
                                    <NavLink to=""><b>SHOP SYSTEM:</b></NavLink>
                                </p>
                                <p style={{ display: 'inline' }} />
                                <br />
                                <p style={{ fontSize: '14px', paddingTop: '5px' }}>
                                    <div><b>SHOWROOM HCM</b> (Working from 08h00 to 21h00) </div><br />
                                    <div>- Address 1: 78-80-82 Hoàng Hoa Thám, Phường 12, Quận Tân Bình.</div><br />
                                    <div>- Address 2: 905 Kha Vạn Cân, Phường Linh Tây, Thành phố Thủ Đức.</div><br />
                                    <div>- Address 3: 1081 - 1083 Trần Hưng Đạo, Phường 5, Quận 5.</div><br />
                                    <div>- Address 4: 415 An Dương Vương, Phường 10, Quận 6.</div><br />
                                    <div><b>SHOWROOM HN </b> (Working from 08h00 to 21h00)</div><br />
                                    <div>- Address 1: 162 - 164 Thái Hà, Phường Trung Liệt, Quận Đống Đa, Hà Nội</div><br />
                                    <div>- Address 2: 460 Minh Khai, Phường Vĩnh Tuy, Quận Hai Bà Trưng, Hà Nội</div><br />
                                </p>
                                ...
                                <br />
                                <div>
                                    <p style={{ fontSize: '14px', paddingTop: '5px' }}>- Address : 436A/71 đường 3/2, Phường 12, Quận 10, Hồ Chí Minh.</p></div>
                                <p style={{ fontSize: '14px', paddingTop: '4px' }}>
                                    <div>- GEARVN TRADING CO., LTD </div><br />
                                    <div>- Business license number 0316517394 issued by the Department of Planning and Investment of Ho Chi Minh City on October 1, 2020 </div><br />
                                    - Director/Owner of website: Đồng Đức Lân <br />
                                </p>
