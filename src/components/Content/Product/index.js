...
const Index = () => {
    ...
    const [listProduct, setListProduct] = useState([
        {
            ...
            description_table: [
                ...
                ["Communication", '1x USB 3.2 Gen 1 Type-A<br/>1x USB 3.2 Gen 1 Type-C<br/>2x USB 2.0 Type-A<br/>1x HDMI 1.4<br/>1x 3.5mm Combo Audio Jack<br/>1x DC-in<br/>'],
    ...
    const checkArrayOrder = (product) => {
        ...
        if (localStorage.getItem('orderArray')) {
            array = JSON.parse(localStorage.getItem('orderArray'))
        } else {
            var array = [];
        }
        function isCherries(fruit) {
            return fruit.src === product.src;
        }
                    ...
                    <div id="maincontent">
                        ...
                        <div className="page_content">
                            <div className="row">
                                ...
                                {product && <ProductParameters product={product} checkArrayOrder={checkArrayOrder} />}
