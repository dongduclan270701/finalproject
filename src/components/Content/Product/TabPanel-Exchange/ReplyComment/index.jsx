...
const Index = ({ comment, product }) => {
    ...
    return (
        <>
                        ...
                        <div className="comment-content">
                            <div className='row' style={{ margin: "0" }}>
                                ...
                                <Dropdown className="comment-options">
                                    ...
                                    <Dropdown.Menu>
                                        <Dropdown.Item onClick={() => handleDeleteReply(replyComment.idReply)}>Delete</Dropdown.Item>
                                    </Dropdown.Menu>
                                </Dropdown>
                            </div>
            ...
            {comment.reply.length === 0 && selectReply === false && <button onClick={setSelectReply} className="btn btn-secondary" style={{ margin: "0 90px" }}>Reply</button>}
            {selectReply && <div className="comment-container">
                <div className="row comment-form" style={{ margin: "0 45px" }}>
                    <div className='border-left-reply'>
                    </div>
