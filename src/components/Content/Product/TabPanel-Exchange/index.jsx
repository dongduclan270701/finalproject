    ...
    return (
        <div role="tabpanel" className="tab-pane" id="tabExchange">
            <div className="comment-container">
                <div className="row comment-form" style={{ margin: "0" }}>
                    ...
                    <input onChange={e => handleChangeChat(e)} value={chatting.content} type="text" className="col-4 comment-input" placeholder="Write a comment" />
                    <button onClick={handleSubmitChat} className="col-1 btn btn-secondary">Post</button>
                </div>
            </div>
            <br />
