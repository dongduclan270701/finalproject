...
const Index = () => {
    ...
    const fetchRequest = async () => {
        const req = await axios.post(`https://ktech-admin.onrender.com/v1/request/requestWebsite`)
        return req.data
    }
    useEffect(() => {
        fetchRequest()
    ...
    return (
        <div className="homepage">
            ...
            <Banner />
            <div>
                <div className='title play-bold'>Laptop Gaming - Best Selling</div>
                ...
                <div className='title play-bold'>Laptop Company - Best Selling</div>
                <div className='title-background'>&emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; </div>
                <hr />

                <TopLaptopCompany laptop={laptop} />

                <div className='title play-bold'>PC Gaming - Best Selling</div>
                <div className='title-background'>&emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; </div>
                <hr />

                <TopPcGaming pcGaming={pcGaming} />

                <div className='title play-bold'>PC Creator - Best Selling</div>
                <div className='title-background'>&emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; </div>
                <hr />

                <TopPcCreator pcCreator={pcCreator} />

                <div className='title play-bold'>PC Company- Best Selling</div>
                <div className='title-background'>&emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; </div>
                <hr />

                <TopPcCompany pcCompany={pcCompany} />

                <div className='title play-bold'>Apple- Best Selling</div>
                <div className='title-background'>&emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; </div>
                <hr />
                ...
                <div className='row d-flex goods'>
                    <div className='col-md-8 mt-4 mb-4 goods-single'>
                        <div className='goods-single-content'>
                            <img src={ads1} alt='ads' style={{ width: "100%",borderRadius:15 }} />
                        </div>
                    </div>
                        ...
                        <div className='row d-flex ads'>
                            <div className='col-md-12 mb-2 ads-single'>
                                <div className='ads-single-content'>
                                    <img src={ads2} alt='ads' style={{ width: "100%",borderRadius:15 }} />
                                </div>
                            </div>
                            <div className='col-md-12 mt-2 ads-single'>
                                <div className='ads-single-content'>
                                    <img src={ads3} alt='ads' style={{ width: "100%",borderRadius:15 }} />
                                </div>
                            </div>
                        </div>
                    </div>
