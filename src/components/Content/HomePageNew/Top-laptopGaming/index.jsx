...
const Index = (props) => {
    ...
    const { laptopGaming } = props
    return (
        <>
            <div className='row d-flex goods'>
            {laptopGaming ? laptopGaming.map((item, index) => {
                    return <div key={index} className='col-md-3 mt-4 mb-4 goods-single'>
                        <div className='goods-card'>
                            <div className='goods-single-content'>
                                ...
                                <h1 className='play-bold' style={{ fontSize: 13, marginLeft:5, marginRight:5 }}>{item.nameProduct}</h1>
