                        ...
                        <div className="gearvn-header-banner">
                            <div className="left">
                                ...
                                <div className="sub-banner-wrap i100">
                                    <a href="" className="sub-item">
                                        <img src="//theme.hstatic.net/1000026716/1000440777/14/solid4.jpg?v=34252" />
                                    </a>
                                    <a href="" className="sub-item">
                                        <img src="//theme.hstatic.net/1000026716/1000440777/14/solid5.jpg?v=34252" />
                                    </a>
                                </div>
                            </div>
                            <div className="right i100">
                                <div className="sub-item-right">
                                    <a href="" className="sub-item">
                                        <img src="//theme.hstatic.net/1000026716/1000440777/14/solid1.jpg?v=34252" />
                                    </a>
                                    <a href="" className="sub-item">
                                        <img src="//theme.hstatic.net/1000026716/1000440777/14/solid2.jpg?v=34252" />
                                    </a>
                                    <a href="" className="sub-item">
                                        <img src="//theme.hstatic.net/1000026716/1000440777/14/solid3.jpg?v=34252" />
                                    </a>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div className="owl-item" style={{ width: '244px', marginRight: '15px' }}>
                                            <li>
                                                <div className="new-product-row">
                                                    <a href="/products/chuot-havit-ms989gt-black">
                                            ...
                                            <div className="new-product-row">
                                                <a href="/products/fan-xigmatek-starz-x22a-argb-pack-x3-controller">
                                                    <div className="new-product-img">
                                            ...
                                            <div className="new-product-row">
                                                <a href="/products/case-jetek-mini-i8-22b-itx">
                                                    <div className="new-product-img">
                                            ...
                                            <div className="new-product-row">
                                                <a href="/products/8g-ddr4-1x8g-2800-g-skill-ripjaws-v">
                                                    <div className="new-product-img">
                                            ...
                                            <div className="new-product-row">
                                                <a href="/products/chuot-cooler-master-mm730-white">
                                                    <div className="new-product-img">
                                ...
                                <div className="module-products row">
                                    {PCGEARN.map((item,index) => {
                                        ...
                                        <div className="product-row">
                                            <a href="/products/gvn-viper-i3050-power-by-gigabyte">
                                            </a><div className="product-row-img"><a href="/products/gvn-viper-i3050-power-by-gigabyte">
                                                <img className="product-row-thumbnail" src={item.img} alt={item.productName} />
                                            </a><div className="product-row-price-hover"><a href="/products/gvn-viper-i3050-power-by-gigabyte">
                                                <div className="product-row-note pull-left">Click để xem chi tiết</div>
                                            </a><a href="/products/gvn-viper-i3050-power-by-gigabyte" className="product-row-btnbuy pull-right">Đặt hàng</a></div></div>
                            ...
                            <div className="loop-pro">
                                <div className="module-products row">
                                    {LAPTOPGAMING.map((item,index) => {
                                        ...
                                        <div className="product-row">
                                            <a href="">
                                            </a><div className="product-row-img"><a href={item.src}>
                                                <img className="product-row-thumbnail" src={item.img} alt={item.productName} />
                                            </a><div className="product-row-price-hover"><a href="">
                                                <div className="product-row-note pull-left">Click để xem chi tiết</div>
                                            </a><a href="" className="product-row-btnbuy pull-right">Đặt hàng</a></div></div>
                                            <h2 className="product-row-name">{item.productName}</h2>
                                            <div className="product-row-info">
                                                <div className="product-row-price pull-left"><del>{item.realPrice}₫</del><br /><span className="product-row-sale">{item.SaleNowPrice}₫</span></div>
                                                {/*<span class="product-row-buyer pull-right"><i class="fa fa-user"></i><br/>185</span>*/}
