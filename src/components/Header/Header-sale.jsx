...
const HeaderSale = () => {
    return (
        <div id="HEADER" className="ladi-section" data-top={0} data-left={0} data-sticky="true" style={{ width: '100%', top: '0px', left: '0px', position: 'fixed', zIndex: 90000050 }}>
            <div className="ladi-section-background" />
            <div className="ladi-container">
                <div data-action="true" id="MENU_MO" className="ladi-element">
                ...
                <div data-action="true" id="BUTTON249" className="ladi-element">
                    <div className="ladi-button">
                        <div className="ladi-button-background" />
                        <div id="BUTTON_TEXT249" className="ladi-element ladi-button-headline">
                            <p className="ladi-headline ladi-transition">
                                Liên Hệ</p>
                        </div>
                    </div>
