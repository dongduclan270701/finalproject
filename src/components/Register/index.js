                ...
                <div className="userbox">
                    <form acceptCharset="UTF-8" action="/account" id="create_customer" method="post">
                        ...
                        <div id="first_name" className="input-group">
                            ...
                            <input required type="text" defaultValue="" name="customer[first_name]" placeholder="Họ" id="first_name" className="text form-control" size={30} />
                        </div>
                        <div id="last_name" className="input-group">
                            <span className="input-group-addon"><i className="fa fa-user" /></span>
                            <input required type="text" defaultValue="" name="customer[last_name]" placeholder="Tên" id="last_name" className="text form-control" size={30} />
                        </div>
                        <div id="email" className="input-group">
                            <span className="input-group-addon"><i className="fa fa-envelope" /></span>
                            <input required type="email" defaultValue="" name="customer[email]" placeholder="email" id="email" className="text form-control" size={30} onChange={(e) => setInputForm((inputForm) => ({ ...inputForm, username: e.target.value }))} />
                        </div>
                        <div id="email" className="input-group">
                            <span className="input-group-addon"><i className="fa fa-phone" /></span>
                            <input required type="text" defaultValue="" name="customer[phone]" placeholder="phone" id="phone" className="text form-control" size={30} />
                        </div>
